...
console.log('Q: ' + q1);
console.log('A:' + a1);
if (a1.toLowerCase() === 'yes' || 'y' ) {
  alert ('Sorry, Ariel has two siblings.');
}
else if (a1.toLowerCase() === 'no' || 'n') {
...
console.log('Q: ' + q2);
console.log('A:' + a2);
if (a2.toLowerCase() === 'yes' || 'y') {
  alert ('You\'re right! Ariel is crazy about knitting.');
}
else if (a2.toLowerCase() === 'no' || 'n') {
...
console.log('Q: ' + q3);
console.log('A:' + a3);
if (a3.toLowerCase() === 'yes' || 'y') {
  alert ('No way! Ariel hates rap.');
}
else if (a3.toLowerCase() === 'no' || 'n') {
...
console.log('Q: ' + q4);
console.log('A:' + a4);
if (a4.toLowerCase() === 'yes' || 'y') {
  alert ('No, Ariel grew up in Seattle.');
}
else if (a4.toLowerCase() === 'no' || 'n') {
...
console.log('Q: ' + q5);
console.log('A:' + a5);
if (a5.toLowerCase() === 'yes' || 'y') {
  alert ('Right, Ariel has two cats.');
}
else if (a5.toLowerCase() === 'no' || 'n') {
